...
function Header() {
    return (
        <header className={"px-6 py-1 flex items-center justify-center md:justify-between"}>
            <a href={"#"} className={"cursor-pointer"}>
                <SparklesText text={"Mễ"}
            ...
            <nav className={"hidden md:flex md:items-center"}>
                ...
                {/*</a>*/}
                <a href="#"
                   className="relative px-4 mr-4 hover:border-b-0 duration-200 before:absolute before:bottom-0 before:left-1/2 before:w-0 before:h-[2px] before:bg-foreground  before:transition-all before:duration-300 hover:before:left-0 hover:before:w-full">
                    Menu
                </a>
                <button className={"px-4 py-2 border-2 border-solid border-black rounded-lg" +
                    " bg-foreground" +
